...
{$PRODUCT_FILE = "../examples/$($release)/elease}/elease}/spring.json"}
...
$piv_release = Get-PIVRelease -id $slug_id | where-object version -Match $PCF_SPRING_VERSION | Select-Object -First 1
