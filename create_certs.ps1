...
[ alt_names ]
DNS.1 = *.system.$PCF_SUBDOMAIN_NAME.$PCF_DOMAIN_NAME
DNS.2 = *.login.system.$PCF_SUBDOMAIN_NAME.$PCF_DOMAIN_NAME
DNS.3 = *.uaa.system.$PCF_SUBDOMAIN_NAME.$PCF_DOMAIN_NAME
